...
class Example {
    string message = "Hello from the class member!";
    
public:
    void display() {
        // Lambda expression using 'this' to access the instance's member
        auto task = [ this ]() {
...
int main(int argc, const char * argv[]) {
    ...
    
    {
        ...
        // [ this, &n, m ] to capture a class members, the [this] is used. The [this]
        // in the lambda capture list allows the lambda to access the members of
